...
export default function Messages() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold text-slate-900 mb-6">💬 消息</h1>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center py-16">
          ...
          <p className="text-slate-500 text-lg mb-2">暂无消息</p>
          ...
          {conversations.map((conv) => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-3 p-4 bg-white rounded-lg border border-slate-200 hover:shadow-sm hover:border-indigo-200 transition-all no-underline"
              >
                {/* 头像 */}
